        ...
        if system_ == 'linux':
            if machine_ == 'x86_64':
                ...
                if system_info.find('16.04') != -1:
                    libpath = os.path.abspath(currentPath + "/BaseSDK/Ubuntu16.04/Lib/libScepter_api.so")
                    ...
                    libpath = os.path.abspath(currentPath + "/BaseSDK/Ubuntu/Lib/libScepter_api.so")
                    #libpath = (os.path.abspath(os.path.dirname(os.getcwd()) + os.path.sep + "../../../../BaseSDK/"))+"/Ubuntu/Lib/libScepter_api.so"
                    print(libpath)
                    self.sc_cam_lib = cdll.LoadLibrary(libpath)
            elif machine_ == 'aarch64':
                libpath = os.path.abspath(currentPath + "/BaseSDK/AArch64/Lib/libScepter_api.so")
            ...
            if machine_ == 'amd64':
                if architecture_ == '64bit':
                    libpath = os.path.abspath(currentPath + "/camara_arriba/BaseSDK/Windows/Bin/x64/Scepter_api.dll")
                    #libpath = (os.path.abspath(os.path.dirname(os.getcwd()) + os.path.sep + "../../../../BaseSDK/"))+"/Windows/Bin/x64/Scepter_api.dll"
                    print(libpath)
                    self.sc_cam_lib = cdll.LoadLibrary(libpath)
                else:
                    libpath = os.path.abspath(currentPath + "/camara_arriba/BaseSDK/Windows/Bin/x86/Scepter_api.dll")
