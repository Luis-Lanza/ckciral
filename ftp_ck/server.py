...
def get_ftp_status(response: Response):
    activo = ftp_status.ftp_esta_activo("172.19.69.253", 2121)
...
def get_puntos_bols_vzsense():
    ...
    conf = image_process.ImgConfirmation(dims, 5,0.3, tam_min= 90000, tam_max=200000)
...
def get_puntos_bols_vzsense_sal2():
    ...
    conf = image_process.ImgConfirmation(dims,6,1 ,tam_min= 90000, tam_max=180000)
...
def get_puntos_bols_vzsense_sal1():
    #print("===================", posicion_actual)
    centers_mm, dif_angles, dims = vzense_proces.geCenters(posicion_actual.x, posicion_actual.y, posicion_actual.z, posicion_actual.c, posicion_actual.b, posicion_actual.a, min_area=90000, max_area = 190000, altura_foto= 1690)
    conf = image_process.ImgConfirmation(dims,6, 3 ,tam_min= 90000, tam_max=250000)
